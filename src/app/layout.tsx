...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${playfairDisplay.variable}`}>
      <head>
        <link rel="icon" href="/logos/fav_blue_16x16.ico" />
        <link rel="apple-touch-icon" sizes="180x180" href="/logos/fav_blue_180x180.ico" />
        <link rel="icon" type="image/x-icon" sizes="32x32" href="/logos/fav_blue_32x32.ico" />
        <link rel="icon" type="image/x-icon" sizes="16x16" href="/logos/fav_blue_16x16.ico" />
